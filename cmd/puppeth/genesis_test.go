...
// Tests the mfachain to Aleth chainspec conversion for the Stureby testnet.
func TestAlethSturebyConverter(t *testing.T) {
	blob, err := ioutil.ReadFile("testdata/stureby_mfachain.json")
	if err != nil {
...
// Tests the mfachain to Parity chainspec conversion for the Stureby testnet.
