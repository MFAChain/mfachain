...
// setting up a new or managing an existing MFA private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your MFA private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new MFA network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and mfastats servers |")
	...
	log.Info("Administering MFA network", "name", w.network)
