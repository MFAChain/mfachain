Name "mfa ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/MFAChain/mfachain/issues"
!define UPDATEURL "https://github.com/MFAChain/mfachain/releases"
!define ABOUTURL "https://github.com/MFAChain/mfachain#MFA-go"
...
# Install mfa binary
Section "mfachain" MFA_IDX
  SetOutPath $INSTDIR
  file {{.mfachain}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\mfa.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\mfa.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "mfachain incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "mfachain outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "mfachain UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "mfachain incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\mfa.exe" "" "" "MFA" 30303 "" "" ""
  SimpleFC::AdvAddRule "mfachain outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\mfa.exe" "" "" "MFA" "" 30303 "" ""
  SimpleFC::AdvAddRule "mfachain UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\mfa.exe" "" "" "MFA" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/MFAChain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "MFA_SOCKET" "R" "HKLM" "\\.\pipe\mfa.ipc"
  ${EnvVarUpdate} $0 "MFA_SOCKET" "A" "HKLM" "\\.\pipe\mfa.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${MFA_IDX}
    SectionGetSize ${MFA_IDX} $0
