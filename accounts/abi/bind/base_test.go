...
func (mc *mockCaller) CallContract(ctx context.Context, call mfa.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call mfa.CallMsg) ([]byte, error) {
