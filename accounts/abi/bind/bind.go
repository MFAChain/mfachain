...
// Package bind generates MFA contract Go bindings.
//
// Detailed usage document and tutorial available on the mfachain Wiki page:
// https://github.com/MFAChain/mfachain/wiki/Native-DApps:-Go-bindings-to-MFA-contracts
package bind
