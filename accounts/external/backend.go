...
import (
	...
	"github.com/MFAChain/mfachain/signer/core"
)
...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain mfa.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to MFA-type signature.
		signature[64] -= 27 // Transform V from MFA-legacy to 0/1
	}
