...
// Package graphql provides a GraphQL interface to MFA node data.
package graphql
...
// Account represents an MFA account at a particular block.
type Account struct {
...
// Transaction represents an MFA transaction.
...
type CallData struct {
	From     *common.Address // The MFA address the call is from.
	To       *common.Address // The MFA address the call is to.
