...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db mfadb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db mfadb.Database) error {
