...
// ecrecover extracts the MFA account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the MFA address
...
// MFA testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     mfadb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // MFA address of the signing key
...
func New(config *params.CliqueConfig, db mfadb.Database) *Clique {
...
// Author implements consensus.Engine, returning the MFA address recovered
