...
func NewTable(db mfadb.Database, prefix string) mfadb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) mfadb.Iterator {
...
func (t *table) NewBatch() mfadb.Batch {
...
func (b *tableBatch) Replay(w mfadb.KeyValueWriter) error {
