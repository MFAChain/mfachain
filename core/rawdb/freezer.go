...
//   reserving it for mfachain. This would also reduce the memory requirements
//   of mfachain, and thus also GC overhead.
type freezer struct {
...
func (f *freezer) freeze(db mfadb.KeyValueStore) {
