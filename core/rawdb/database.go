...
import (
	...
	"github.com/MFAChain/mfachain/mfadb/leveldb"
	"github.com/MFAChain/mfachain/mfadb/memorydb"
...
func NewDatabase(db mfadb.KeyValueStore) mfadb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db mfadb.KeyValueStore, freezer string, namespace string) (mfadb.Database, error) {
...
func NewMemoryDatabase() mfadb.Database {
...
func NewMemoryDatabaseWithCap(size int) mfadb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (mfadb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (mfadb.Database, error) {
...
func InspectDatabase(db mfadb.Database) error {
