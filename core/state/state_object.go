...
// stateObject represents an MFA account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of MFA address of the account
	data     Account
	db       *StateDB
...
// Account is the MFA consensus representation of accounts.
