...
func wipeSnapshot(db mfadb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db mfadb.KeyValueStore) error {
...
func wipeKeyRange(db mfadb.KeyValueStore, kind string, prefix []byte, keylen int) error {
