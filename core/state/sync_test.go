...
// account array.
func checkStateAccounts(t *testing.T, db mfadb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db mfadb.Database, root common.Hash) error {
...
func checkStateConsistency(db mfadb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(mfadb.Database), srcRoot)
