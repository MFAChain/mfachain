...
// Package state provides a caching layer atop the MFA state trie.
package state
...
// StateDBs within the MFA protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/MFAChain/mfachain/pull/16485#issuecomment-380438527),
