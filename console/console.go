...
import (
	...
	"github.com/MFAChain/mfachain/internal/jsre"
	"github.com/MFAChain/mfachain/internal/jsre/deps"
	"github.com/MFAChain/mfachain/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute MFA requests through
...
func (c *Console) initExtensions() error {
	...
	aliases := map[string]struct{}{"mfa": {}, "personal": {}}
	for api := range apis {
		if api == "web3" {
			continue
		}
...
// Welcome show summary of current mfachain instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the mfachain JavaScript console!\n\n"

	// Print some generic mfachain metadata
