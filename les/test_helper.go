...
import (
	...
	"github.com/MFAChain/mfachain/accounts/abi/bind/backends"
	"github.com/MFAChain/mfachain/common"
	"github.com/MFAChain/mfachain/common/mclock"
	"github.com/MFAChain/mfachain/consensus/mfa"
	"github.com/MFAChain/mfachain/contracts/checkpointoracle/contract"
	...
	"github.com/MFAChain/mfachain/les/flowcontrol"
...
func testIndexers(db mfadb.Database, odr light.OdrBackend, config *light.IndexerConfig) []*core.ChainIndexer {
...
func newTestClientHandler(backend *backends.SimulatedBackend, odr *LesOdr, indexers []*core.ChainIndexer, db mfadb.Database, peers *serverPeerSet, ulcServers []string, ulcFraction int) *clientHandler {
	var (
...
func newTestServerHandler(blocks int, indexers []*core.ChainIndexer, db mfadb.Database, peers *clientPeerSet, clock mclock.Clock) (*serverHandler, *backends.SimulatedBackend) {
	var (
		gspec = core.Genesis{
			Config:   params.AllEthashProtocolChanges,
			Alloc:    core.GenesisAlloc{bankAddr: {Balance: bankFunds}},
