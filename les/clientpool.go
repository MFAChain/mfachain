...
func newClientPool(db mfadb.Database, freeClientCap uint64, clock mclock.Clock, removePeer func(enode.ID)) *clientPool {
...
func newNodeDB(db mfadb.Database, clock mclock.Clock) *nodeDB {
