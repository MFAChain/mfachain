...
type accessTestFn func(db mfadb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }
func TestBlockAccessLes3(t *testing.T) { testAccess(t, 3, tfBlockAccess) }

func tfBlockAccess(db mfadb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db mfadb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db mfadb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db mfadb.Database, bhash common.Hash, num uint64) light.OdrRequest {
