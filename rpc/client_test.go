	...
	check := func(shouldPanic bool, arg interface{}) {
		defer func() {
			...
			if shouldPanic && err == nil {
				t.Errorf("MfaSubscribe should've panicked for %#v", arg)
			}
			if !shouldPanic && err != nil {
				t.Errorf("MfaSubscribe shouldn't have panicked for %#v", arg)
...
// This test reproduces https://github.com/MFAChain/mfachain/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("mfachain-test-ipc-%d-%d", os.Getpid(), rand.Int63())
