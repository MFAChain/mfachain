...
const (
	// bloomServiceThreads is the number of goroutines used globally by an MFA
...
func (eth *MFA) startBloomHandlers(sectionSize uint64) {
...
// for the MFA header bloom filters, permitting blazing fast filtering.
type BloomIndexer struct {
	size    uint64               // section size to generate bloombits for
	db      mfadb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db mfadb.Database, size, confirms uint64) *core.ChainIndexer {
