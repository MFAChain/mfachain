...
var (
	...
	mfaashChainConfig *params.ChainConfig
...
func init() {
	...
	mfaashChainConfig = params.TestChainConfig
...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db mfadb.Database, n int) *testWorkerBackend {
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db mfadb.Database, blocks int) (*worker, *testWorkerBackend) {
...
func TestEmptyWorkEthash(t *testing.T) {
	testEmptyWork(t, mfaashChainConfig, mfa.NewFaker())
}
...
func TestStreamUncleBlock(t *testing.T) {
	...
	w, b := newTestWorker(t, mfaashChainConfig, mfa, rawdb.NewMemoryDatabase(), 1)
	defer w.close()
...
func TestRegenerateMiningBlockEthash(t *testing.T) {
	testRegenerateMiningBlock(t, mfaashChainConfig, mfa.NewFaker())
}
...
func TestAdjustIntervalEthash(t *testing.T) {
	testAdjustInterval(t, mfaashChainConfig, mfa.NewFaker())
}
