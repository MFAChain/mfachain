...
type Database struct {
	diskdb mfadb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb mfadb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb mfadb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() mfadb.KeyValueReader {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch mfadb.Batch, uncacher *cleaner) error {
