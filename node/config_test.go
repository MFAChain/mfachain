...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "mfa.ipc", false, filepath.Join(os.TempDir(), "mfa.ipc")},
		{"data", "mfa.ipc", false, "data/mfa.ipc"},
		{"data", "./mfa.ipc", false, "./mfa.ipc"},
		{"data", "/mfa.ipc", false, "/mfa.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "mfa.ipc", true, `\\.\pipe\mfa.ipc`},
		{"data", "mfa.ipc", true, `\\.\pipe\mfa.ipc`},
		{"data", `\\.\pipe\mfa.ipc`, true, `\\.\pipe\mfa.ipc`},
	}
