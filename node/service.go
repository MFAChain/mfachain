...
func (ctx *ServiceContext) OpenDatabase(name string, cache int, handles int, namespace string) (mfadb.Database, error) {
...
func (ctx *ServiceContext) OpenDatabaseWithFreezer(name string, cache int, handles int, freezer string, namespace string) (mfadb.Database, error) {
	if ctx.Config.DataDir == "" {
		return rawdb.NewMemoryDatabase(), nil
	}
